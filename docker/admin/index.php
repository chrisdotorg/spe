...
<body>
	...
	<!-- SIDEBAR -->
	<section id="sidebar">
		<a href="index.php" class="brand"><i class='bx bxs-smile icon'></i> Mail server administator</a>
		<ul class="side-menu">
			...
			<li>
				...
				<ul class="side-dropdown">
					<li><a href="#">Reload the server</a></li>
					<li><a href="#">Start the server</a></li>
					<li><a href="#">Stop the server</a></li>
				</ul>
			</li>
						...
						<div>
							<h2>
								<?php 
									...
									$reponse = $bdd->query('SELECT * FROM domaines');
